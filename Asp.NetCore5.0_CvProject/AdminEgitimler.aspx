                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:HyperLink NavigateUrl='<%# "AdminEgitimGuncelle.aspx?ID="+Eval("ID") %>' ID="HyperLink3" runat="server" CssClass="btn btn-primary" style="margin-top:5px">Güncelle</asp:HyperLink>
