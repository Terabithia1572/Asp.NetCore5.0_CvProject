<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminHobiGuncelle.aspx.cs" Inherits="Asp.NetCore5._0_CvProject.AdminHobiGuncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <form id="Form1" runat="server">
        <div class="form-group">
            ...
            <br />
            <div>
                <asp:Label ID="Label2" runat="server" Text="Hobilerim"></asp:Label>
