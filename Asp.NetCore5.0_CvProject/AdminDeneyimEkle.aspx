<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminDeneyimEkle.aspx.cs" Inherits="Asp.NetCore5._0_CvProject.AdminDeneyimEkle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
      ...
      <form id="Form1" runat="server">
        <div class="form-group">
            ...
            <asp:Button ID="btn_Ekle" runat="server" Text="Kaydet" CssClass="btn btn-primary" OnClick="btn_Ekle_Click" />
